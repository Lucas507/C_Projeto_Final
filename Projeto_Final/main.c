...
int main(void) {
    char jogador[20];
    int limonadas, limoes = 0, agua = 0, acucar = 0, vendas, i;
    ...
    for (i = 1; orcamento > 0; i++) {
        ...
        if (fornecedor == true) {
            ...
            do {
                ...
                if (scanf("%d", &limoes) != 1 || limoes < 0) {
                    printf("\nIntroduza um número positivo");
                    getchar();
                    continue;
                }

                verificar_orcamento = orcamento - (limoes * 0.2);
                if (verificar_orcamento < limoes * 0.2) {
                    printf("\nSaldo insuficiente");
                    printf("\nSaldo atual: %.2f €", orcamento);
                    printf("\nCusto total: %.2f €", limoes * 0.2);
                    getchar();
                    continue;
                }
            ...
            do {
                ...
                if (scanf("%d", &acucar) != 1 || acucar < 0) {
                    printf("\nIntroduza um número positivo");
                    getchar();
                    continue;
                }

                verificar_orcamento = orcamento - (acucar * 0.35);
                if (verificar_orcamento < acucar * 0.35) {
                    printf("\nSaldo insuficiente");
                    printf("\nSaldo atual: %.2f €", orcamento);
                    printf("\nCusto total: %.2f €", acucar * 0.35);
                    getchar();
                    continue;
                }
            ...
            do {
                ...
                verificar_orcamento = orcamento - (agua * 0.1);
                if (verificar_orcamento < agua * 0.1) {
                    printf("\nSaldo insuficiente");
                    printf("\nSaldo atual: %.2f €", orcamento);
                    printf("\nCusto total: %.2f €", agua * 0.1);
                    getchar();
                    continue;
                }
        ...
        float lucro = vendas * (preco - (limoes * 0.2) - (acucar * 0.35) - (agua * 0.1));
        orcamento += lucro;
